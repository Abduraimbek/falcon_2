...
class OrderAzamModel {
  ...
  factory OrderAzamModel.nullModel() {
    return OrderAzamModel(
      postedBy: null,
      orderId: null,
      pickUpAt: null,
      pickUpDate: null,
  ...
  factory OrderAzamModel.fromRowList(List<Element> row) {
    final model = OrderAzamModel.nullModel();
  ...
  static List<OrderAzamModel> storeList(String html) {
    ...
    final list = rowList.map((e) => OrderAzamModel.fromRowList(e)).toList();
    return list;
  }
}
