...
//
//       // await _writeLogFalcon("Worked correctly");
//
//       return response.body;
//     } catch (e) {
//       // await _writeLogFalcon("$e");
//       return null;
//     }
//   }
//
...
//
//       // await _writeLogAzam("Worked correctly");
//
//       return response.body;
//     } catch (e) {
//       // await _writeLogAzam("$e");
//       return null;
//     }
//   }
//
...
// }
//
// // Future<void> _writeLogFalcon(String text) async {
// //   String dirPath = r"C:\ProgramData\falcon_log.txt";
...
// // }
//
// // Future<void> _writeLogAzam(String text) async {
// //   String dirPath = r"C:\ProgramData\azam_log.txt";
// //   File file = File(dirPath);
// //
// //   await file.writeAsString(
// //     "${DateTime.now()}\n$text\n\n",
